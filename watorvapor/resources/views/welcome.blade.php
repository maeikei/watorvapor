...
<div class="container">
	<div class="row" height="10%">
		<div class="col-md-10 col-md-offset-1">
			...
			<a href="{{ asset('assets/img/brain.king.jpg') }}" ><img height="80%" src="{{ asset('assets/img/brain.king.jpg') }}"><a>
			<a href="{{ asset('assets/img/brain.skelton.jpg') }}" ><img height="80%" src="{{ asset('assets/img/brain.skelton.jpg') }}"><a>
	...
	<div class="row" height="10%">
		<div class="col-md-10 col-md-offset-1">
			...
			<a href="{{ asset('assets/img/ai.dream.jpg') }}" ><img height="80%" src="{{ asset('assets/img/ai.dream.jpg') }}"><a>
	...
	<div class="row" height="10%">
		<div class="col-md-10 col-md-offset-1">
			...
			<a href="{{ asset('assets/img/digital.soul.jpg') }}" ><img height="80%" src="{{ asset('assets/img/digital.soul.jpg') }}"><a>
			<a href="{{ asset('assets/img/digital.Consciousness.binary.jpg') }}" ><img height="80%" src="{{ asset('assets/img/digital.Consciousness.binary.jpg') }}"><a>
	...
	<div class="row" height="10%">
		<div class="col-md-10 col-md-offset-1">
			...
			<a href="{{ asset('assets/img/robot.brain.white.jpg') }}" ><img height="80%" src="{{ asset('assets/img/robot.brain.white.jpg') }}"><a>
	...
	<div class="row" height="10%">
		<div class="col-md-10 col-md-offset-1">
			...
			<a href="{{ asset('assets/img/space.travel.jpg') }}" ><img height="80%" src="{{ asset('assets/img/space.travel.jpg') }}"><a>
	...
	<div class="row" height="10%">
		<div class="col-md-10 col-md-offset-1">
			...
			<a href="{{ asset('assets/img/kepler.daison.jpg') }}" ><img height="80%" src="{{ asset('assets/img/kepler.daison.jpg') }}"><a>
